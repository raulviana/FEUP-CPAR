...
int main(int argc, char *argv[])
{
    ...
    do
    {
        ...
        do
        {
            ...
            printf("L1 DCM: %lld \n", values[0]);
            printf("L2 DCM: %lld \n", values[1]);
            int FLOP = (2.0f * startSize * startSize * startSize / (time / 1000.0f)) * 1.0e-9f;
            Time4 = clock();
            fileStream << startSize << ", " << time << ", " << FLOP << (double)(Time4 - Time3) / CLOCKS_PER_SEC;
